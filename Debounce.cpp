...
bool Debounce::get_raw_button_state() {
  ...
  // THEN THE CHANGED BUTTON STATE IS VALID AND A SWITCH HAS HAPPEND:
  ...
  // RETURN RAW (NOT DEBOUNCED) BUTTON STATE
  return _current_button_state;
}

bool Debounce::switched_high() {
  Debounce::get_raw_button_state();
