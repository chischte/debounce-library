...
Debounce::Debounce(const byte BUTTON_PIN) { _BUTTON_PIN = BUTTON_PIN; }
//***************************************************************************
//LIBRARY FUNCTIONS:
//***************************************************************************

void Debounce::set_debounce_time(int debounce_time) { _debounce_time = debounce_time; }

bool Debounce::get_button_state() {

  _current_button_state = digitalRead(_BUTTON_PIN);

  // ACTIVATE DEBOUNCE TIMER IF BUTTON STATE HAS CHANGED:
  ...
  return _debounced_button_state;
}
...
bool Debounce::switched_high() {
  ...
  bool switched_high = _button_switched_high;
  _button_switched_high = false;
